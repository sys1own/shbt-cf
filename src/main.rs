...
fn main() {
    ...
    println!("Screened deuteron pair energy V_driven: {:.2} eV", summary.v_driven);
    ...
    println!("MPC action: laser = {:.6}, cooling = {:.6}", summary.control_laser, summary.control_cooling);
    println!("");
