...
def compute_fatigue_lifetime_mc(
    ...
    *,
    ...
    """Sample bounded plastic strain and evaluate Coffin-Manson life."""
    if epsilon_f_prime <= 0 or c == 0 or std_dev_strain <= 0 or iterations < 1:
        raise ValueError("invalid Coffin-Manson parameters")
